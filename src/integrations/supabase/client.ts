...
function createSupabaseClient() {
  ...
  if (SUPABASE_URL.includes("kxqhyvxcdiqlfbaytswf.supabase.co")) {
    throw new Error(
      "Invalid Supabase URL loaded. Update VITE_SUPABASE_URL in .env to the correct project host.",
    );
  }

  console.debug("Supabase client using URL:", SUPABASE_URL);
